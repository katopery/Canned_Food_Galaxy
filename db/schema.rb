...
ActiveRecord::Schema.define(version: 2024_03_07_161112) do
  ...
  create_table "canned_foods", force: :cascade do |t|
    t.string "canned_name", null: false
    t.text "description", null: false
    t.boolean "is_canned_status", default: true, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "canned_tags", force: :cascade do |t|
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.boolean "is_member_status", default: true, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
